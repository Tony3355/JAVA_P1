...
public class Estudi {
    ...
    public static Estudi addEstudi() {
        System.out.println("Introduzca el NIF del estudio");
        String nom = DADES.nextLine();
        System.out.println("Introduzca la direccion del estudio");
    ...
    public void updateEstudi() {
        this.showEstudi();
        System.out.println("Introduce el nuevo nombre del estudio:");
        String nom = DADES.nextLine();
        System.out.println("Introduce la nueva direccion del estudio");
        String adreca = DADES.nextLine();
    ...
    public void addTorn() {
        ...
        torn = Torn.addTorn();
        posicion = this.selectTorn(torn.getCodi());
    ...
    public void addProjecte() {
        ...
        posicion = this.selectProjecte(projecte.getCodi());
